...
/**
 * This class implements a specialized vertex view for a System Dynamics auxiliary node.
 * 
 * @author Joachim Melcher, Institut AIFB, Universitaet Karlsruhe (TH), Germany
 * @version 1.0
 */
public class AuxiliaryNodeVertexView extends VertexView {
   
   private static final long serialVersionUID = 1L;
   
   private static AuxiliaryNodeVertexRenderer renderer = AuxiliaryNodeVertexRenderer.getInstance();

   /**
    * Constructor.
    * 
    * @param cell auxiliary node vertex
    */
   public AuxiliaryNodeVertexView(Object cell) {
      super(cell);
   }
